...
> **Nomes:** Eduardo Donato  **Turma:** ____________________   **Data:** 17/ 09 / 2026
...
É um Sql injection na linha, 4 e 5;

2. Qual o dano possível em produção?

ele pode vazar dados, ja que, ele pode puxar todos os dados, os nomes

3. Como corrigir?

Ele pode passar um parametro para que o a consulta seja txt, nao um comando em si
...
Ele não está fazendo uma autenticação para ver a fatura, caso seja outro usario identificando ela sendo possivel um vazamento de dados.

2. Qual o dano possível em produção?

Um Dano possivel seria o vazamento de dados, consigo ver fatura, limite transações etc...

3. Como corrigir?

Colocar um autenticador no usuario, ex: if usuario != clientid, retorna um erro
...
Possui uma senha em uma variel publica junto com aqueri de busca

2. Qual o dano possível em produção?

Senhas vazadas levando a alteração de dados no login

3. Como corrigir?

COnfigurar por ambiente e usar secrets
...
Seria a string role, pois o usuario consegue editar o cargo, para admin ou usuario

2. Qual o dano possível em produção?

alterção de usuario levando a um usuario comum com funcoes de admin, levando a erros graves

3. Como corrigir?

Deletar a string role, ou colocar ela privada para que o usuario não altere

## DESAFIO

1. Qual das 4 falhas um scanner automático de código teria MAIS dificuldade de encontrar? Por quê?

A idor, pois um scanner provavelmente não ira entender regras de negocio, que precisaria de uma autenticação para alterar o usuario
